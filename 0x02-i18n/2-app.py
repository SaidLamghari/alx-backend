...
"""
Application web Flask avec intégration de
Babel pour l'internationalisation.
Cette application rend une page d'accueil
et sélectionne la langue appropriée
...
class Config:
    ...
    BABEL_DEFAULT_TIMEZONE (str): Fuseau horaire par défaut utilisé par Babel.
                Ici, le fuseau horaire UTC est défini comme valeur par défaut.
    """
...
def get_locale():
    """
    Détermine la meilleure langue à
    utiliser en fonction des préférences du client.

    Retourne:
    str: Le code de langue qui correspond le mieux aux préférences du client.
    """
    # Sélectionne la langue préférée du client
    # en fonction des langues supportées par l'application
...
def index():
    ...
    Retourne:
    str: La page HTML rendue avec le modèle '2-index.html'.
    """
